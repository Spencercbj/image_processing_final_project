"""
Pipeline v11: Restormer → resize 1920 → OMDNet → Sharpen(1.5) → Real-ESRGAN x3

Baseline: NO low-light enhancement. Direct comparison with:
- v9  (CLAHE + same params)
- v10 (HVI-CIDNet + same params)
"""
import glob
import sys
import os
...
def main():
    ...
    results_dir = os.path.join(BASE_DIR, 'results', 'pipeline_v11')
    restormer_dir = os.path.join(results_dir, 'step1_restormer')
    resize_dir = os.path.join(results_dir, 'step2_resize_1920')
    ...
    print('Pipeline v11: Restormer → resize 1920 → OMDNet → Sharpen(1.5) → ESRGAN x3')
    print('(NO low-light enhancement — baseline)')
    ...
    # Step 2: Resize to 1920
    print('=' * 60)
    print('STEP 2: Resize 1920')
    print('=' * 60)
    ...
    # Step 5: Real-ESRGAN x3
    print('=' * 60)
    print('STEP 5: Real-ESRGAN x3')
    print('=' * 60)
    ...
    print(f'Pipeline v11 done in {elapsed / 60:.1f} min.')
